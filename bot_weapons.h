...
#define BOT_GAUSS_SECONDARY_MIN_DISTANCE 0.0f
#define BOT_GAUSS_SECONDARY_PREFERRED_DISTANCE 700.0f
#define BOT_GAUSS_SECONDARY_MAX_DISTANCE 3000.0f
#define BOT_GAUSS_CHARGE_DISTANCE_CLOSE 96.0f
#define BOT_GAUSS_CHARGE_DISTANCE_MEDIUM 350.0f
#define BOT_GAUSS_CHARGE_DISTANCE_LONG 700.0f
#define BOT_GAUSS_CHARGE_DISTANCE_FAR 1200.0f
#define BOT_GAUSS_CHARGE_DISTANCE_EXTREME 1800.0f
#define BOT_GAUSS_CHARGE_TIME_MINIMUM 0.20f
#define BOT_GAUSS_CHARGE_TIME_CLOSE 0.24f
#define BOT_GAUSS_CHARGE_TIME_MEDIUM 0.42f
#define BOT_GAUSS_CHARGE_TIME_LONG 0.68f
#define BOT_GAUSS_CHARGE_TIME_FAR 0.95f
#define BOT_GAUSS_CHARGE_TIME_EXTREME 1.20f
#define BOT_GAUSS_SECONDARY_MIN_CHARGE_TIME BOT_GAUSS_CHARGE_TIME_MINIMUM
#define BOT_GAUSS_SECONDARY_MAX_CHARGE_TIME 1.32f
#define BOT_GAUSS_SECONDARY_HARD_RELEASE_TIME 1.60f
#define BOT_GAUSS_AMMO_BURN_INTERVAL 0.10f
#define BOT_GAUSS_SECONDARY_MIN_AMMO 3
#define BOT_GAUSS_DISTANCE_PLAN_HYSTERESIS 64.0f
#define BOT_GAUSS_DEADLINE_HYSTERESIS 0.04f
#define BOT_GAUSS_MAX_DEADLINE_EXTENSION 0.25f
#define BOT_GAUSS_OVERWATCH_ARRIVAL_DISTANCE 72.0f
