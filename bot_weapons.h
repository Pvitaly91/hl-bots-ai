...
#define BOT_GAUSS_SECONDARY_MIN_DISTANCE 350.0f
#define BOT_GAUSS_SECONDARY_PREFERRED_DISTANCE 700.0f
#define BOT_GAUSS_SECONDARY_MAX_DISTANCE 3000.0f
#define BOT_GAUSS_SECONDARY_MIN_CHARGE_TIME 0.55f
#define BOT_GAUSS_SECONDARY_MAX_CHARGE_TIME 1.35f
#define BOT_GAUSS_SECONDARY_HARD_RELEASE_TIME 1.60f
#define BOT_GAUSS_SECONDARY_MIN_AMMO 12
