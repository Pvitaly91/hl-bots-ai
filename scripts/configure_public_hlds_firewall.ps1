...
$report = [ordered]@{
    ...
    verification_succeeded = $runningAsAdmin -and [bool]$afterInspection.query_successful -and $matchingAllow
    action_taken = $actionTaken
    rule_name = $RuleName
    selected_rule_name = $RuleName
    port = $Port
    selected_port = $Port
    protocol = "UDP"
    ...
    firewall_enumeration_available = $runningAsAdmin
    ...
    warning = $warning
    IsAdministrator = $runningAsAdmin
    applyAttempted = $applyAttempted
    applySucceeded = $applySucceeded
    verificationSucceeded = $runningAsAdmin -and [bool]$afterInspection.query_successful -and $matchingAllow
    selectedPort = $Port
    selectedRuleName = $RuleName
    firewallEnumerationAvailable = $runningAsAdmin
    artifacts = [ordered]@{
